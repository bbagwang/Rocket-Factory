...
public class Smithy extends Combine {

    int[] possibleItem;

    public Smithy() {
        possibleItem = new int[6];
        ...
        possibleItem[4] = ObjectCode.IronTool;
        possibleItem[5] = ObjectCode.Hoe;
    }
    ...
    public void Create(Vector2 pos, int size, Bitmap[] AnimationImage, Bitmap[] _image) {
        ...
        temp[0] = new ItemCell(ObjectCode.Wood, 10, ItemCell.Material);
        temp[1] = new ItemCell(ObjectCode.Coal, 3, ItemCell.RawMaterials);
        temp[2] = new ItemCell(ObjectCode.Anvil, 1, ItemCell.Consumption);
