...
public class Water extends Material {
    ...
    public void Create(Vector2 _pos, int _size, Global global) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(global.context.getResources(), R.drawable.tilewater);
        bitmap = Bitmap.createScaledBitmap(bitmap,
                global.blackSide.UnitConversion(844),
                global.blackSide.UnitConversion(212), true);

        Create(_pos, _size, ObjectCode.Water, bitmap, global);
    }
}
